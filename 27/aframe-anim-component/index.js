...
AFRAME.registerComponent('anim', {
    ...
    init: function () {
        for (let i = 1; i < this.data.amount; i++) {
            ...
            box.setAttribute('src', './assets/models/probe.obj');
            box.setAttribute('color', this.getRandomColor());
            box.setAttribute('position', this.getRandomInt(-60, -120) + ' ' + this.getRandomInt(-
                24, 60) + ' ' + this.getRandomInt(-50, -1));
            ...
            box.setAttribute('animation__pos', {
                ...
                dir: 'alternate',
                dur: 60000,
                to: this.getRandomInt(-1, 240) + ' ' + this.getRandomInt(-
                    8, 240) + ' ' + this.getRandomInt(-240, -1),
                easing: 'easeInSine',
                loop: true
            });
    ...
    init: function () {
        for (let i = 1; i < this.data.amount; i++) {
            ...
            box.setAttribute('animation__pos', {
                ...
                dir: 'alternate',
                dur: 10000,
                to: this.getRandomInt(-30, -58) + ' ' + this.getRandomInt(-
                    8, 30) + ' ' + this.getRandomInt(-25, -1),
                easing: 'easeInSine',
                loop: true
            });
